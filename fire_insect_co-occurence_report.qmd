---
title: "fire_insect_co-occurence_report"
format: html
editor: visual
...
make a function that tries a bunch of different matching, with and without replacement
...
# tsd 1-2 matching on a probit PS
m.out_w1 <- matchit(history ~  host_pct +isi_90 + dc_90+ dmc_90 + ffmc_90 + bui_90 + fwi_90,
                  data = hist_gt90_1,
                  method = "nearest",
                  distance = "glm",
                  link = "logit",
...
# tsd 1-2 matching on a probit PS
m.out_w2 <- matchit(history ~  host_pct  + isi_90 + dc_90+ dmc_90 + ffmc_90 + bui_90 + fwi_90,
                  data = hist_gt90_2,
                  method = "nearest",
                  distance = "glm",
                  link = "logit",
                 ...
                 ### set a maximum distance for the matches
                 caliper = 0.2
                 #mahvars = ~host_pct +isi_90 + dc_90+ dmc_90 + ffmc_90 + bui_90 + fwi_90,
)

# tsd 1-2 matching on a probit PS
m.out_w3 <- matchit(history ~  host_pct +  isi_90 + dc_90+ dmc_90 + ffmc_90 + bui_90 + fwi_90,
                  data = hist_gt90_3,
                  distance = "glm",
                  m.order = "random",
                  caliper = .2,
...
method <- best_model_1$info$method
distance <- best_model_1$info$distance
link <- best_model_1$info$link

extract_best_model_params(best_model_1)
